...
@property (nonatomic, strong,nullable) UILabel *tipLabel;
...
- (void)drawScanRect
{
  ...
  //画矩形框4格外围相框角
    ...
    self.tipLabel.frame = CGRectMake(127.f, _scanRetangleRect.origin.y+_scanRetangleRect.size.height+18.f, 150, 47);
